...
class screenController {
  ...
  static makeContent() {
    ...
    console.log(_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getProjects());
    console.log(_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getActiveProject());
  ...
  static populateProjectArea(projectArea) {
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos()
      .getProjects()
      ...
      .forEach((projectName) => {
        ...
        projectButton.addEventListener("click", () => {
          _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].setProjectActive(projectName);
          screenController.displayTasks();
          document.getElementById("project-title").textContent =
            _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getActiveProject().projectName;
        });
        deleteProjectButton.textContent = "X";
        deleteProjectButton.addEventListener("click", () => {
          _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].deleteProject(projectEntry.id);
  ...
  static populateTaskArea(taskGrid) {
    if (!_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getActiveProject()) {
      return;
    }
    _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos()
      .getActiveProject()
      ...
      .forEach((task) => {
        ...
        deleteTaskButton.addEventListener("click", () => {
          _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTask(deleteTaskButton.id);
          screenController.displayTasks();
        });
  ...
  static makeProjectInput() {
    ...
    newProjectForm.onsubmit = (e) => {
      e.preventDefault();
      const newProject =
        _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getProjects().length > 0
          ? new _project__WEBPACK_IMPORTED_MODULE_1__["default"](projectNameInput.value)
          : new _project__WEBPACK_IMPORTED_MODULE_1__["default"](projectNameInput.value, [], true);
  ...
  static makeNewTaskEntry() {
    ...
    taskEntry.onsubmit = (e) => {
      ...
      if (_Storage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodos().getProjects().length > 0) {
        _Storage__WEBPACK_IMPORTED_MODULE_2__["default"].addTask(
          new _task__WEBPACK_IMPORTED_MODULE_3__["default"](
            taskTitle.value,
...
class Task {
  ...
  getFormattedDate() {
    return this.dueDate === "" ? "" : (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns_toDate__WEBPACK_IMPORTED_MODULE_1__["default"])(this.dueDate), 'E, do MMM YYY');
  }
